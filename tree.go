...
func (n *node) insertChild(numParams uint8, path, fullPath string, handler HandlerFunc) {
...
// given path.
func (n *node) getValue(path string) (handler HandlerFunc, p Params, tsr bool) {
